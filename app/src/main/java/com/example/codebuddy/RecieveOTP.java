        ...
        buttonverify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (inputcode.getText().toString().trim().isEmpty()) {
                    Toast.makeText(RecieveOTP.this, "Please enter the valid code", Toast.LENGTH_SHORT).show();
                }
                ...
                if (verifiactionId != null) {
                    ...
                    PhoneAuthCredential phoneAuthCredential = PhoneAuthProvider.getCredential(verifiactionId, code);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(RecieveOTP.this, "Invalid OTP", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
        ...
        findViewById(R.id.textresendotp).setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber("+91" + getIntent().getStringExtra("mobile"), 60,
                        TimeUnit.SECONDS, RecieveOTP.this,
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                Toast.makeText(RecieveOTP.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                            ...
                            public void onCodeSent(String newverificationId, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(RecieveOTP.this, "OTP send", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
